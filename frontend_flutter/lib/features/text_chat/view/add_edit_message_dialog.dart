...
Future<void> showAddMessageDialog(BuildContext context, {Message? replyToMessage, String? replyToQuote}) async {
...
Future<void> showEditMessageDialog(BuildContext context, {required Message messageToEdit}) async {
  final listModel = context.read<MessageListModel>();
  showModalBottomSheet(
    context: context,
    isScrollControlled: true,
      ...
      builder: (context, _) {
        return Stack(
          children: [
            ...
            if (widget.model.isWaiting) Positioned.fill(child: Container(color: Colors.black.withAlpha(80))),
          ],
        );
      },
    );
