...
//   String? replyToQuote,
// }) async {
//   // Извлекаем модель из контекста для передачи в новый Route, потому что в новом Route
//   // контекст всегда корневой, а вложенные Navigator() мы тут не используем.
...
//     final message = widget.model.addNewMessage;
