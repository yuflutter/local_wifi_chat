...
/// Поддерживает стек и полиморфизм. Используется в слоях, где недоступен BuildContext.
/// Производительность практически аналогична Map, в высоко-нагруженных сервисах лучше сохранять зависимость локально.
class DI {
