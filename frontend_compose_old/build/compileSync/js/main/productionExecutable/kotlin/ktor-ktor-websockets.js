(function (root, factory) {
  ...
  function Companion() {
    ...
    while (inductionVariable < last) {
      ...
      var tmp$ret$0 = element.x24_1;
      destination.n2(tmp$ret$0, element);
    }
    tmp.y24_1 = destination;
    this.z24_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  protoOf(Companion).a25 = function (code) {
    return this.y24_1.x2(code);
  };
  ...
  protoOf(CloseReason).d25 = function () {
    return Companion_getInstance().a25(this.b25_1);
  };
  protoOf(CloseReason).toString = function () {
    var tmp0_elvis_lhs = this.d25();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.b25_1 : tmp0_elvis_lhs) + ', message=' + this.c25_1 + ')';
  };
  protoOf(CloseReason).hashCode = function () {
    var result = this.b25_1;
  ...
  function Companion_0() {
    ...
    tmp.i25_1 = ensureNotNull(tmp$ret$1).h25_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.i25_1 + 1 | 0;
  ...
  function Text_init_$Init$_0(text, $this) {
    ...
    $l$block: {
      ...
      if (charset.equals(Charsets_getInstance().s1j_1)) {
        tmp$ret$0 = encodeToByteArray(text);
        break $l$block;
      }
      tmp$ret$0 = encodeToByteArray_0(charset.w1j(), text, 0, text.length);
    }
  ...
  function Close_init_$Init$(reason, $this) {
    ...
    $l$block: {
      ...
      try {
        ...
        writeShort(builder, reason.b25_1);
        writeText(builder, reason.c25_1);
  ...
  function Close_init_$Init$_1($this) {
    Close.call($this, Companion_getInstance_1().k25_1);
    return $this;
  }
  ...
  function Frame(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    rsv3 = rsv3 === VOID ? false : rsv3;
    this.l25_1 = fin;
    this.m25_1 = frameType;
    this.n25_1 = data;
    this.o25_1 = disposableHandle;
    this.p25_1 = rsv1;
    this.q25_1 = rsv2;
    this.r25_1 = rsv3;
  }
  protoOf(Frame).toString = function () {
    return 'Frame ' + this.m25_1 + ' (fin=' + this.l25_1 + ', buffer len = ' + this.n25_1.length + ')';
  };
  //region block: init
